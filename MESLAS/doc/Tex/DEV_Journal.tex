...
\begin{figure}[tbh!p]
\centering
\subfloat[Conditional mean]{\includegraphics[scale=0.6]{images/coverage_mean.png}}\\
\subfloat[Sample conditional realisation]{\includegraphics[scale=0.6]{images/coverage_realisation.png}}\\
\subfloat[Conditional Coverage Function]{\includegraphics[scale=0.6]{images/coverage_coverage.png}}
